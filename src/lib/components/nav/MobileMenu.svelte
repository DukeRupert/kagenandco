...
{#if $isMobileMenuOpen}
	<div
		class="bg-white z-30 fixed w-full h-full pb-12 flex flex-col overflow-y-auto"
		transition:fly={{ duration: 300, x: -900, opacity: 0.1, easing: quartOut }}
	>
		<!-- Links -->
		...
		<div class="border-t border-gray-200 py-6 px-4 space-y-6">
			<div class="flow-root">
				<a href="/locations" class="-m-2 p-2 block font-medium text-gray-900">Locations</a>
			</div>
		</div>
