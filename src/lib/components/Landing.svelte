				...
				<div class="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
					<div class="w-full max-w-xl lg:shrink-0 xl:max-w-2xl">
						...
						<div class="mt-10 flex items-center gap-x-6">
							<a
								href="#"
								class="rounded-md bg-custard-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-custard-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-custard-600"
								>Get started</a
							>
