...
<main class="lg:relative bg-oldGrey">
	<div class="mx-auto max-w-7xl w-full pt-16 pb-20 text-center lg:py-48 lg:text-left">
		<div class=" px-4 lg:w-1/2 sm:px-8 xl:pr-16">
			...
			>
				...
				<span class="block text-custard-500 xl:inline">online business</span>
			</h1>
	...
	>
		<img class="absolute inset-0 w-full h-full object-cover" src="/crepe_strawberry.webp" alt="" />
	</div>
</main>
